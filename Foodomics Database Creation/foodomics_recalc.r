...
UCURdb$FNA_F4D0 <- ifelse(is.na(UCURdb$FNA_F4D0),(UCURdb$X607/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F4D0)
UCURdb$FNA_F6D0 <- ifelse(is.na(UCURdb$FNA_F6D0),(UCURdb$X608/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F6D0)
UCURdb$FNA_F8D0 <- ifelse(is.na(UCURdb$FNA_F8D0),(UCURdb$X609/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F8D0)
UCURdb$FNA_F10D0 <- ifelse(is.na(UCURdb$FNA_F10D0),(UCURdb$X610/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F10D0)
UCURdb$FNA_F12D0 <- ifelse(is.na(UCURdb$FNA_F12D0),(UCURdb$X611/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F12D0)
UCURdb$FNA_F13D0 <- ifelse(is.na(UCURdb$FNA_F13D0),(UCURdb$X696/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F13D0)
UCURdb$FNA_F14D0 <- ifelse(is.na(UCURdb$FNA_F14D0),(UCURdb$X612/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F14D0)
UCURdb$FNA_F15D0 <- ifelse(is.na(UCURdb$FNA_F15D0),(UCURdb$X652/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F15D0)
UCURdb$FNA_F16D0 <- ifelse(is.na(UCURdb$FNA_F16D0),(UCURdb$X613/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F16D0)
UCURdb$FNA_F17D0 <- ifelse(is.na(UCURdb$FNA_F17D0),(UCURdb$X653/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F17D0)
UCURdb$FNA_F18D0 <- ifelse(is.na(UCURdb$FNA_F18D0),(UCURdb$X614/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D0)
UCURdb$FNA_F20D0 <- ifelse(is.na(UCURdb$FNA_F20D0),(UCURdb$X615/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D0)
UCURdb$FNA_F22D0 <- ifelse(is.na(UCURdb$FNA_F22D0),(UCURdb$X624/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D0)
UCURdb$FNA_F24D0 <- ifelse(is.na(UCURdb$FNA_F24D0),(UCURdb$X654/apply(UCURdb[433:446],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_saturatedfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F24D0)
...
UCURdb$FNA_F14D1 <- ifelse(is.na(UCURdb$FNA_F14D1),(UCURdb$X625/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F14D1)
UCURdb$FNA_F15D1 <- ifelse(is.na(UCURdb$FNA_F15D1),(UCURdb$X697/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F15D1)
UCURdb$FNA_F17D1 <- ifelse(is.na(UCURdb$FNA_F17D1),(UCURdb$X687/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F17D1)
UCURdb$FNA_F20D1 <- ifelse(is.na(UCURdb$FNA_F20D1),(UCURdb$X628/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D1)
UCURdb$FNA_F16D1C <- ifelse(is.na(UCURdb$FNA_F16D1C),(UCURdb$X673/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F16D1C)
UCURdb$FNA_F16D1 <- ifelse(is.na(UCURdb$FNA_F16D1),(UCURdb$X626/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F16D1)
UCURdb$FNA_F18D1C <- ifelse(is.na(UCURdb$FNA_F18D1C),(UCURdb$X674/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D1C)
UCURdb$FNA_F18D1 <- ifelse(is.na(UCURdb$FNA_F18D1),(UCURdb$X617/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D1)
UCURdb$FNA_F22D1C <- ifelse(is.na(UCURdb$FNA_F22D1C),(UCURdb$X676/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D1C)
UCURdb$FNA_F22D1 <- ifelse(is.na(UCURdb$FNA_F22D1),(UCURdb$X630/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D1)
UCURdb$FNA_F24D1C <- ifelse(is.na(UCURdb$FNA_F24D1C),(UCURdb$X671/apply(UCURdb[447:457],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_monofat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F24D1C)
###############################POLY FAT############################
...
UCURdb$FNA_F18D4 <- ifelse(is.na(UCURdb$FNA_F18D4),(UCURdb$X627/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D4)
UCURdb$FNA_F21D5 <- ifelse(is.na(UCURdb$FNA_F21D5),(UCURdb$X857/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F21D5)
UCURdb$FNA_F22D4 <- ifelse(is.na(UCURdb$FNA_F22D4),(UCURdb$X858/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D4)
UCURdb$FNA_F18D2 <- ifelse(is.na(UCURdb$FNA_F18D2),(UCURdb$X618/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D2)
UCURdb$FNA_F18D3CN3 <- ifelse(is.na(UCURdb$FNA_F18D3CN3),(UCURdb$X851/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D3CN3)
UCURdb$FNA_F18D3CN6 <- ifelse(is.na(UCURdb$FNA_F18D3CN6),(UCURdb$X685/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D3CN6)
UCURdb$FNA_F18D3 <- ifelse(is.na(UCURdb$FNA_F18D3),(UCURdb$X619/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D3)
UCURdb$FNA_F20D2CN6 <- ifelse(is.na(UCURdb$FNA_F20D2CN6),(UCURdb$X672/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D2CN6)
UCURdb$FNA_F20D3N3 <- ifelse(is.na(UCURdb$FNA_F20D3N3),(UCURdb$X852/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D3N3)
UCURdb$FNA_F20D3N6 <- ifelse(is.na(UCURdb$FNA_F20D3N6),(UCURdb$X853/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D3N6)
UCURdb$FNA_F20D3 <- ifelse(is.na(UCURdb$FNA_F20D3),(UCURdb$X689/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D3)
UCURdb$FNA_F20D4N6 <- ifelse(is.na(UCURdb$FNA_F20D4N6),(UCURdb$X855/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D4N6)
UCURdb$FNA_F20D4 <- ifelse(is.na(UCURdb$FNA_F20D4),(UCURdb$X620/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D4)
UCURdb$FNA_F20D5 <- ifelse(is.na(UCURdb$FNA_F20D5),(UCURdb$X629/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F20D5)
UCURdb$FNA_F22D5 <- ifelse(is.na(UCURdb$FNA_F22D5),(UCURdb$X631/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D5)
UCURdb$FNA_F22D6 <- ifelse(is.na(UCURdb$FNA_F22D6),(UCURdb$X621/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D6)
UCURdb$FNA_F183I <- ifelse(is.na(UCURdb$FNA_F183I),(UCURdb$X856/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F183I)
UCURdb$FNA_F182I <- ifelse(is.na(UCURdb$FNA_F182I),(UCURdb$X666/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F182I)
UCURdb$FNA_F18D2CN6 <- ifelse(is.na(UCURdb$FNA_F18D2CN6),(UCURdb$X675/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D2CN6)
UCURdb$FNA_F18D2CLA <- ifelse(is.na(UCURdb$FNA_F18D2CLA),(UCURdb$X670/apply(UCURdb[458:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_polyfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D2CLA)
#########################TRANS FAT###################
...
UCURdb$FNA_F16D1T <- ifelse(is.na(UCURdb$FNA_F16D1T),(UCURdb$X662/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F16D1T)
UCURdb$FNA_F18D1T <- ifelse(is.na(UCURdb$FNA_F18D1T),(UCURdb$X663/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D1T)
UCURdb$FNA_F18D1TN7 <- ifelse(is.na(UCURdb$FNA_F18D1TN7),(UCURdb$X859/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D1TN7)
UCURdb$FNA_F18D2X <- ifelse(is.na(UCURdb$FNA_F18D2X),(UCURdb$X665/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D2X)
UCURdb$FNA_F18D2TT <- ifelse(is.na(UCURdb$FNA_F18D2TT),(UCURdb$X669/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F18D2TT)
UCURdb$FNA_F22D1T <- ifelse(is.na(UCURdb$FNA_F22D1T),(UCURdb$X664/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_F22D1T)
UCURdb$FNA_FATRNM <- ifelse(is.na(UCURdb$FNA_FATRNM),(UCURdb$X693/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_FATRNM)
UCURdb$FNA_FATRNP <- ifelse(is.na(UCURdb$FNA_FATRNP),(UCURdb$X695/apply(UCURdb[470:477],1, function(x) sum(x,na.rm=TRUE)))*(dataframe$calc_transfat-apply(foodlabel,1,function(X) sum(X,na.rm=TRUE))),UCURdb$FNA_FATRNP)
